...
const About = () => {
  return (
    <div style={{height: '100vh', width: '1980px'}} className="bg-gradient-to-br from-slate-700 to-slate-900 overflow-y-auto">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-b from-gray-100 to-gray-200 rounded-2xl p-8 text-center 
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-3" style={{ fontSize: '24px' }}>Authenticity</h3>
              <p className="text-gray-600" style={{ fontSize: '15px' }}>Ensuring real and trusted certificates.</p>
      ...
      <section className="min-h-screen py-20 bg-gradient-to-r from-[#334257] to-[#6F8FBD]">
      ...
      {/* Authenticity Section */}
      <section className="min-h-screen py-20 bg-gradient-to-br from-slate-700 to-slate-900 overflow-y-auto">
        <div className="container mx-auto px-4">
          {/* Title Section */}
          <div className="max-w-4xl mx-auto text-center mb-20">
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold text-white mb-8 mt-40">
